          ...
          children: [
            Container(
              ...
              decoration: BoxDecoration(
                ...
                image: const DecorationImage(image: NetworkImage('https://raw.githubusercontent.com/DeLaRosaRojas/IAMoviles-Act-12-navegaci-n-3-pantallas-tu-Negocio-Flutter/refs/heads/main/telas1.png'), fit: BoxFit.cover, colorFilter: ColorFilter.mode(Colors.black45, BlendMode.darken)),
              ),
              child: const Center(child: Text("TELAS", style: TextStyle(color: Colors.white, fontSize: 28, fontWeight: FontWeight.bold))),
            ),
            const Padding(
              padding: EdgeInsets.symmetric(horizontal: 20),
              child: Text("Catálogo de Telas", style: TextStyle(fontSize: 20, fontWeight: FontWeight.bold)),
            ),
            const Divider(thickness: 3, color: Color(0xFFD4AF37), indent: 20, endIndent: 200),
            
            _cardProducto("Lino Natural", "150.00", 'https://raw.githubusercontent.com/DeLaRosaRojas/IAMoviles-Act-12-navegaci-n-3-pantallas-tu-Negocio-Flutter/refs/heads/main/telas2.png'),
            _cardProducto("Seda Roja", "300.00", 'https://raw.githubusercontent.com/DeLaRosaRojas/IAMoviles-Act-12-navegaci-n-3-pantallas-tu-Negocio-Flutter/refs/heads/main/telas3.png'),
